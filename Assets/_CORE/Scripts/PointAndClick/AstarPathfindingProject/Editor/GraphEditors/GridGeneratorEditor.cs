...
namespace Pathfinding {
	...
	public class GridGraphEditor : GraphEditor {
		...
		protected virtual void DrawCollisionEditor (GraphCollision collision) {
			...
			((GridGraph)target).InvertScan = EditorGUILayout.Toggle(new GUIContent("Invert Collider Scan", "Invert the scan so collider hits generate walkable nodes"), ((GridGraph)target).InvertScan);
